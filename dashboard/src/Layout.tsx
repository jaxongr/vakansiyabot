...
const items = [
  ...
  { key: '/discovery', icon: <RadarChartOutlined />, label: <Link to="/discovery">Kashfiyot</Link> },
  { key: '/monetization', icon: <DollarOutlined />, label: <Link to="/monetization">Daromad</Link> },
